            ...
            <div id="board-enroll-area">
                <form action="insert.bo" method="post">
                    ...
                    <div class="outer">
                        ...
                        <div align="right">
                            <button type="submit" onclick="uplode()"
                    ...
                    <div id="nav" class="bo">
                        <ul style="gap: 10px; list-style: none;">
                            <li><input type="radio" name="category" value="10"><label for="free">자유</label></li>
                            <li><input type="radio" name="category" value="20"><label for="senior">헬창</label></li>
                            <li><input type="radio" name="category" value="30"><label for="begginer">헬린이</label></li>
                            <li><input type="radio" name="category" value="40"><label for="qna">Q / A</label></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <textarea id="content" name="content" rows="10" placeholder="내용을 입력하세요."
                                required></textarea>
                        </div>
                    </div>
                </form>
